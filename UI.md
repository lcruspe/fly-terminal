...
HUD поверх удалённого экрана по умолчанию находится в компактном состоянии: остаётся только небольшой статусный chip с H.264, FPS и текущим разрешением. Наведение или нажатие на chip раскрывает команды `⌘ Space`, `⌘ Tab`, вставку, масштабирование и полноэкранный режим; наведение на весь viewport больше не раскрывает панель.
